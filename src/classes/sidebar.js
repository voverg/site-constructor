...
function block(type='button') {
    return `
        ...
        <div class="row">
            ...
            <input type="number" id="columns" name="columns" class="range input" value="1" min="1" max="6">
        </div>

        <div class="row">
            <label for="margin">Внешний отступ</label>
            <input type="range" id="margin" name="margin" class="range input" min="0" max="100" value="0">
        </div>
        <div class="row">
            <label for="padding">Внутренний отступ</label>
            <input type="range" id="padding" name="padding" class="range input" min="0" max="100" value="0">
        </div>
        <br><hr>
        ...
        <div class="row">
            ...
            <input type="color" id="background" name="background" class="range input" value="#ffffff">
        </div>
        <div class="row">
            <label for="color">Цвет текста</label>
            <input type="color" id="color" name="color" class="range input" value="#333333">
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <select type="select" name="border-style" id="border-style" class="range input">
        ...
        <div class="row">
            ...
            <input type="color" id="border-color" name="border-color" class="range input" value="#333333">
        </div>
        <br><hr>
